...
```powershell
npm install --global --ignore-scripts https://github.com/mvanderbend-msoft/crewbie/releases/download/v0.1.0-alpha.28/crewbie-cli-0.1.0-alpha.28.tgz
gh auth login
```
...
> npm pack
> npm install --global --ignore-scripts .\crewbie-cli-0.1.0-alpha.28.tgz
> ```
>
